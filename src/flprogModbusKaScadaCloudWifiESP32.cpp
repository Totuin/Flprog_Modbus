...
void ModbusKaScadaCloudWifiESP32::setKaScadaCloudIp(uint8_t first_octet, uint8_t second_octet, uint8_t third_octet, uint8_t fourth_octet)
{
...
void ModbusKaScadaCloudWifiESP32::setKaScadaCloudPort(int port)
{
    if (this->port == port)
...
void ModbusKaScadaCloudWifiESP32::setKaScadaCloudDevceId(String id)
{
...
void ModbusKaScadaCloudWifiESP32::begin()
{
    kaScadaCloudTimeOutStartTime = millis() - 5000;
}

void ModbusKaScadaCloudWifiESP32::pool()
{
...
void ModbusKaScadaCloudWifiESP32::sendTxBuffer()
{
    if (buffer[0] == 0)
    {
        return;
...
void ModbusKaScadaCloudWifiESP32::getRxBuffer()
{
    byte currentByte = 0;
