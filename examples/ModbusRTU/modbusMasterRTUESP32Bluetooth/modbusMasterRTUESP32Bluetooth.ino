...
FLProgBluetoothUart RtuDevice("ESP32-BL");
...
void loop()
{
  ...
  value = Master1.readInteger(1, FLPROG_INPUT_REGISTR, 1);
  ...
  /*
   ...
   Master1SlavesTable[1].getLastError(); - получение кода последней ошибки второго слейва
  */
}