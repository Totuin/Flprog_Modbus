...
*/
ModbusMasterRTUoverTCPWifiESP32 Master1(Master1ServersTable, 1);
...
void setup()
{
  // Привязываем к каждомк серверу таблицу его слейвов, последний параметр - количество слейвов на сервере
