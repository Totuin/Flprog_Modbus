...
ModbusMasterRTUHardware Master1(Master1SlavesTable, 2);
...
void loop()
{
  ...
  */
  value = Master1.readInteger(0, INPUT_REGISTR, 0);

  Master1.saveBool(0, tempBool, COIL, 0);
  Master1.saveBool(0, tempBool, COIL, 1);
  Master1.saveBool(1, tempBool, COIL, 1);
  Master1.saveBool(1, tempBool, COIL, 0);
  ...
  Master1.saveInteger(1, tempInt, HOLDING_REGISTR, 2);
  Master1.saveInteger(0, value, HOLDING_REGISTR, 0);
  Master1.saveInteger(1, value, HOLDING_REGISTR, 0);
  Master1.saveInteger(0, tempInt, HOLDING_REGISTR, 6);
  Master1.saveInteger(1, tempInt, HOLDING_REGISTR, 1);
}